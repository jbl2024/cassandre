...
class Command(BaseCommand):
    """
    This command indexes all documents in the Document app, creates embeddings and saves them in vector database.
    It takes an optional argument --category_id to index documents of a specific category.
    """
    help = "Index all documents in the Document app, create embeddings and save them in vector database"
